...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td rowspan="5" width="10%"><img src="https://simpeg.umjambi.ac.id/assets/foto_pegawai/{{($data->foto!="") ? $data->foto:'no-foto-male.png' }}" width="100" height="130"></td>
        </tr>
        <tr>
            <td >NIP/NIDN/NIDK</td><td>:</td><td> {{$data->nip}}</td>
        </tr>
        <tr>
            <td >Tempat, Tanggal Lahir</td><td>:</td><td> {{$data->tempat_lhr.", ".Tanggal::tgl_indo($data->tgl_lhr)}}</td>
        </tr>
        ...
        <tr>
            <td>No HP</td><td>:</td><td colspan="2"> {{$data->telp}}</td>
        </tr>
        <tr>
