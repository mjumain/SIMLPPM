                            ...
                            <tbody>
                                @forelse($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown ">
                                                <button id="dLabel" class="btn btn-primary btn-sm" type="button"
                                                ...
                                                <ul class=" dropdown-menu dropdown-menu-right" aria-labelledby="dLabel">
                                                    <li>
                                                        <a
                                                            href="{{ 'setup-borang/input-borang/proposal/' . $data->id_jenis_skema }}">
                                                            Borang Proposal</a>
                                                        <a
                                                            href="{{ 'setup-borang/input-borang/evaluasi-hasil/' . $data->id_jenis_skema }}">
                                                            Borang Evaluasi Hasil</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
...
@section('js')
    ...
    <script>
        ...
        function hapus(id, rev) {
            alertify.confirm("Konfirmasi!", "Apakah anda yakin menghapus reviewer " + rev + "  dari daftar reviewer?",
                function() {
                    $('#' + id).submit();
                },
                function() {
