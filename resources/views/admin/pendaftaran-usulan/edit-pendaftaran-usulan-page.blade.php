...
@section('content_header')
    ...
    <ol class="breadcrumb">
      ...
      @else
      <li> <a href="{{url('seleksi-usulan')}}"> Seleksi Usulan</a> </li>
      @endif
              ...
              <form class="form-horizontal" id="form-usulan" enctype="multipart/form-data" method="post" action="{{url('pendaftaran-usulan/edit/'.encrypt($data->id_usulan))}}">
                ...
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  ...
                  <div class="col-lg-7 col-xs-12" style="padding-top: 5px;">
                    <select name="id_peg" id="ketua" class="form-control select2peg" width="100%" >
                        
                        
                        <option value="{{$data->ketua->id_peg}}" selected="">{{$data->ketua->pegawai->nip." - ".Helpers::nama_gelar($data->ketua->pegawai)}}</option>
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-xs-12">
                    <label class="col-lg-3 control-label">Anggota {{$loop->iteration}} </label>
                    <div class="col-lg-7 col-xs-12" style="padding-top: 5px;">
                      <input type="hidden" name="id_pelaksana[]" value="{{$anggota->id_pelaksana}}">
                      <select name="id_peg_anggota[]" class="form-control select2peg" required="" width="100%" >
                          
                          
                        <option value=""></option>
                        @if($anggota->pegawai)
                        <option value="{{$anggota->pegawai->id_pegawai}}" selected="">{{$anggota->pegawai->nip." - ".Helpers::nama_gelar($anggota->pegawai)}}</option>
                        @endif
                ...
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  <label class="col-lg-3 control-label">File Proposal Tanpa Nama</label>
                  <div class="col-lg-7 col-xs-12" >
                    {!!Helpers::cek_dokumen($data->file_proposal_tanpa_nama,'proposal')!!} 
                    <p><i>Silahkan upload ulang file proposal jika terjadi perubahan pada dokumen proposal yg telah direvisi</i></p>
                  </div>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  ...
                  <div class="col-lg-offset-3 col-lg-7 col-xs-12" >
                    ...
                    <input type="file" class="form-control"  name="file_proposal_tanpa_nama" accept="application/pdf">
                    <span class="message"> </span>
                  </div>
                </div>
                @if($data->status=='revisi')
