    ...
    <div class="col-lg-12 col-xs-12">
      ...
      <div class="box box-info">
          ...
          <div class="row setup-content" id="step-1">
            <div class="col-lg-12">
              <form class="form-horizontal" id="form-usulan" enctype="multipart/form-data" method="post" action="{{url('pendaftaran-usulan/'.encrypt($jenis_usulan->id_jenis_usulan))}}">
                ...
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  ...
                  <div class="col-lg-7 col-xs-12">
                    <select name="jumlah_anggota" class="form-control"  id="jumlah_anggota" required="">
                      ...
                      @endphp
                      <option value="0">Tidak pakai anggota</option>
                      @for($i=1; $i<=$setup ; $i++)
                ...
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  <label class="col-lg-3 control-label">File Proposal @include('wajib')</label>
                  <div class="col-lg-7 col-xs-12" >
                    <div class="pull-right">
                ...
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  <label class="col-lg-3 control-label">File Proposal Tanpa Nama @include('wajib')</label>
                  <div class="col-lg-7 col-xs-12" >
                    <div class="pull-right">
                      <small><i>Format file <b>PDF</b>, maksimal ukuran <b>5 MB</b></i></small>
                    </div>
                    <input type="file" class="form-control"  name="file_proposal_tanpa_nama" required="" accept="application/pdf">
                    <span class="message"> </span>
                  </div>
                </div>
              </form>
        ...
        <div class="box-footer">
          <small>Keterangan : @include('wajib') Wajib diisi!</small>
