...
@section('title', 'Seleksi Usulan')

@section('content_header')
    <h1>Seleksi Usulan</h1>
    <ol class="breadcrumb">
      <li class="active"><a href="{{url('seleksi-usulan')}}"><i class="fa fa-user"></i> Kelola user</a></li>
    </ol>
@stop
...
@section('content')
    ...
    <div class="col-lg-12 col-xs-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <form action="{{url('seleksi-usulan/ekspor-excel')}}" method="post" id='form-excel'>
            @csrf
            ...
            <div class="form-group col-lg-3 col-md-3 col-xs-12">
              ...
              <select name="status_usulan" class="form-control" id="status_usulan" onchange="load_data()">
                ...
                <option value="ajukan_kembali">Ajukan Kembali (Sudah revisi)</option>
            ...
            <div class="form-group col-lg-6 col-md-6 col-xs-12">
              ...
              <button style="margin-top: 27px" class="btn btn-sm btn-success" type="button" onclick="excel('v1')"><i class="fa fa-file-excel-o"></i> Excel Master V1</button>&nbsp;&nbsp;
              <button style="margin-top: 27px" class="btn btn-sm btn-success" type="button" onclick="excel('v2')"><i class="fa fa-file-excel-o"></i> Excel Master V2</button>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="pull-right">
                  <button class="btn btn-primary " type="button" onclick="aksi_proses_usulan()"><i class="fa fa-wrench"></i> Proses Usulan</button>
                </div>
              </div>
            </div>
            <br>
  ...
  <div class="modal fade" id="tambah-reviewer">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="{{url('seleksi-usulan/input-reviewer')}}" method="post" id="form-tambah-reviewer" class="form-horizontal">
                @csrf
                <div class="modal-header">
                    <div class="modal-title">
...
@section('js')
  @include('plugins.alertify-js')
    <script>
          ...
          $('#table').DataTable( {
            ...
            ajax: {
              ...
              data:{
                ...
                skim_id:$("#skim_id").val(),
                jenis_skema_id:$("#jenis_skema_id").val(),
      ...
      function hapus_reviewer_proposal(id,nama,judul) {
        alertify.confirm("Konfirmasi!","Apakah anda yakin menghapus sdr/i <b>"+nama+"</b> sebagai reviewer dari kegiatan yang berjudul <b>"+judul+"</b> ?",function(){
          window.location.href="{{url('seleksi-usulan/hapus-reviewer')}}/"+id;
        },function(){

        })
      }
      function tambah_reviewer_proposal(id_usulan,reviewer_ke) {
