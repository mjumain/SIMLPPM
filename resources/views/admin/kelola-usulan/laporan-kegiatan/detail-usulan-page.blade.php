...
@section('content_header')
    <h1>Detail Usulan</h1>
    <ol class="breadcrumb">
      <li><a href="{{url('laporan-kegiatan')}}"><i class="fa fa-book"></i> Laporan Kegiatan</a></li>
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
         <ul class="nav nav-tabs" id="#myTab">
            ...
            <li><a href="#upload-laporan" data-toggle="tab">Upload Laporan</a></li>
            <li><a href="#hardcopy-laporan" data-toggle="tab">Penyerahan Hardcopy Laporan</a></li>
          ...
          <div class="tab-content">
            ...
            <div id="upload-laporan" class="tab-pane fade">
              @include('layouts.data-laporan-incl')
              
            </div>
            <div id="hardcopy-laporan" class="tab-pane fade">
